...
### Phase 3: テンプレート機能（一部MVP）

- [x] 11.1 デフォルトテンプレート提供機能（MVP）
  - 1つの汎用デフォルトテンプレートの作成（質問項目は開発者が提供）
  - テンプレート選択UIの実装
  - 選択したテンプレートの質問一括追加機能
  - _要件: 3.1, 3.2_

- [ ] 11.2 独自テンプレート作成機能
  - 現在の質問リストをテンプレートとして保存する機能
  - 保存したテンプレートの管理（名前変更、削除）
  - テンプレート一覧表示とプレビュー機能
  - テンプレートのカスタマイズ・編集機能
  - _要件: 3.3, 3.4_

- [ ] 11.3 テンプレートプレビュー機能（Phase 1）
  - テンプレート適用前の質問内容確認UI
  - 質問項目の一覧表示（折りたたみ可能）
  - 既存質問との重複チェック表示
  - プレビューダイアログからの直接適用機能
...
- [ ] 11.4 テンプレート管理ページ（Phase 2）
  - 専用のテンプレート管理ページの作成
  - BottomNavigationに「テンプレート」項目追加
  - システムテンプレート・カスタムテンプレートの一覧表示
  - テンプレートの詳細表示・比較機能
  - カスタムテンプレートの作成・編集・削除UI
