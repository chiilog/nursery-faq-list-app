...
interface QuestionListState {
  ...
  updateQuestionList: (id: string, updates: UpdateQuestionListInput) => Promise<void>;
  ...
  updateQuestion: (listId: string, questionId: string, updates: UpdateQuestionInput) => Promise<void>;
  deleteQuestion: (listId: string, questionId: string) => Promise<void>;
  answerQuestion: (listId: string, questionId: string, answer: string) => Promise<void>;
  reorderQuestions: (listId: string, fromIndex: number, toIndex: number) => Promise<void>;
  
  // アクション: テンプレート管理
  loadTemplates: () => Promise<void>;
  createFromTemplate: (templateId: string, customizations: CreateQuestionListInput) => Promise<string>;
  ...
  // アクション: ユーティリティ
  getQuestionListStats: (listId: string) => { total: number; answered: number; unanswered: number; progress: number } | null;
  ...
  devtools(
    (set, get) => ({
      ...
      async loadQuestionLists() {
        ...
        try {
          setLoading({ isLoading: true, operation: "質問リストを読み込み中..." });
          clearError();
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問リストの読み込みに失敗しました",
        ...
        try {
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問リストの作成に失敗しました",
            code: error instanceof DataStoreError ? error.code : "CREATE_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
        ...
        try {
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問リストの更新に失敗しました",
            code: error instanceof DataStoreError ? error.code : "UPDATE_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
        ...
        try {
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問リストの削除に失敗しました",
            code: error instanceof DataStoreError ? error.code : "DELETE_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
        ...
        try {
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問リストの読み込みに失敗しました",
            code: error instanceof DataStoreError ? error.code : "LOAD_CURRENT_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
        } finally {
        ...
        try {
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問の追加に失敗しました",
            code: error instanceof DataStoreError ? error.code : "ADD_QUESTION_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
      ...
      async updateQuestion(listId: string, questionId: string, updates: UpdateQuestionInput) {
        const { setLoading, clearError, setCurrentList } = get();
        ...
        try {
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問の更新に失敗しました",
            code: error instanceof DataStoreError ? error.code : "UPDATE_QUESTION_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
        ...
        try {
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問の削除に失敗しました",
            code: error instanceof DataStoreError ? error.code : "DELETE_QUESTION_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
      ...
      async reorderQuestions(listId: string, fromIndex: number, toIndex: number) {
        ...
        try {
          ...
          for (const question of reorderedQuestions) {
            await dataStore.updateQuestion(listId, question.id, { order: question.order });
          }
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問の並び替えに失敗しました",
            code: error instanceof DataStoreError ? error.code : "REORDER_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
      ...
      async loadTemplates() {
        ...
        try {
          setLoading({ isLoading: true, operation: "テンプレートを読み込み中..." });
          clearError();
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "テンプレートの読み込みに失敗しました",
            code: error instanceof DataStoreError ? error.code : "LOAD_TEMPLATES_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
        } finally {
      ...
      async createFromTemplate(templateId: string, customizations: CreateQuestionListInput) {
        const { setLoading, clearError, loadQuestionLists } = get();
        
        try {
          setLoading({ isLoading: true, operation: "テンプレートから作成中..." });
          clearError();
          
          const newListId = await dataStore.createFromTemplate(templateId, customizations);
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "テンプレートからの作成に失敗しました",
            code: error instanceof DataStoreError ? error.code : "CREATE_FROM_TEMPLATE_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
        ...
        try {
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "データの削除に失敗しました",
            code: error instanceof DataStoreError ? error.code : "CLEAR_DATA_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
      ...
      async sortCurrentListByAnswerStatus() {
        ...
        try {
          ...
          const sortedQuestions = sortQuestionsByAnswerStatus(currentList.questions);
          
          // 順序を一括更新
          for (const question of sortedQuestions) {
            await dataStore.updateQuestion(currentList.id, question.id, { order: question.order });
          }
          ...
          const appError: AppError = {
            message: error instanceof DataStoreError 
              ? error.message 
              : "質問の並び替えに失敗しました",
            code: error instanceof DataStoreError ? error.code : "SORT_BY_ANSWER_FAILED",
            timestamp: new Date(),
          };
          set({ error: appError });
          throw error;
